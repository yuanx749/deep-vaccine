...
Positive_test.lst = combine(
    Positive_T.df, Positive_B.df, Positive_T.test, Positive_B.test, "Positive_test.txt"
)
Negative_train.lst = combine(
    Negative_T.df,
    Negative_B.df,
    Negative_T.train,
    Negative_B.train,
...
Negative_test.lst = combine(
    Negative_T.df, Negative_B.df, Negative_T.test, Negative_B.test, "Negative_test.txt"
)
